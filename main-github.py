...
class ServerSettings(BaseSettings):
    ...
    host: str = "0.0.0.0"
    port: int = 8000
    # server_url: AnyHttpUrl = AnyHttpUrl("https://mcp-server-auth-822395763299.asia-northeast3.run.app:8080/sse")
    server_url: str = "https://mcp-server-auth-822395763299.asia-northeast3.run.app"
    # server_url: AnyHttpUrl = AnyHttpUrl("https://0.0.0.0:8080")

    # GitHub OAuth settings - MUST be provided via environment variables
    github_client_id: str = "Ov23li3OMwnof0cJUkWz" # Type: MCP_GITHUB_GITHUB_CLIENT_ID env var
    github_client_secret: str = "14a3b5029d5dc36add5663093013abf28ea63bfd" # Type: MCP_GITHUB_GITHUB_CLIENT_SECRET env var
    github_callback_path: str = "https://mcp-server-auth-822395763299.asia-northeast3.run.app/github/callback"
...
def main():
    ...
    #     return 1
    settings = ServerSettings(host="0.0.0.0", port=8080)
